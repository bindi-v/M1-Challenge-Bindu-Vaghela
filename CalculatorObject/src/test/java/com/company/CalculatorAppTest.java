...
//    }
    ...
    public void shouldReturnSumOfTwoDoubles() {
        ...
        assertEquals(failMessage, 5.3, calc.add(2.2d, 3.1d), 0.001);
        assertEquals(failMessage, -1, calc.add(2.0d, -3d), 0.001);
        assertEquals(failMessage, 8.6, calc.add(7.6d, 1d), 0.001);
    }
    ...
    public void shouldReturnDifferenceOfTwoDoubles() {
        ...
        assertEquals(failMessage, -0.9, calc.subtract(2.2d, 3.1d), 0.001);
        assertEquals(failMessage,  5, calc.subtract(2.0d, -3d), 0.001);
        assertEquals(failMessage, 6.6, calc.subtract(7.6d, 1d), 0.001);
    }
    ...
    public void shouldReturnProductOfTwoDoubles() {
        ...
        assertEquals(failMessage, 6.82, calc.multiply(2.2d, 3.1d), 0.001);
        assertEquals(failMessage, -6, calc.multiply(2.0d, -3d), 0.001);
        assertEquals(failMessage, 7.6, calc.multiply(7.6d, 1d), 0.001);
    ...
    public void shouldReturnQuotientOfTwoDoubles() {
        ...
        assertEquals(failMessage, 0.7096, calc.divide(2.2d, 3.1d), 0.001);
        assertEquals(failMessage, -0.6666, calc.divide(2.0d, -3d), 0.001);
        assertEquals(failMessage, 7.6, calc.divide(7.6d, 1d), 0.001);
    }
}